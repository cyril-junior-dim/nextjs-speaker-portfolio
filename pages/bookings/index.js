            ...
            <div className={`${styles.bookingsContent} section__padding`}>
                <div className={"offersList"}>
                    ...
                    <div className={styles.bookingsOffers}>
                        <div className={"coaching-offer"} data-aos={"fade-up"}>
                        ...
                        <div className={"keynote-offer"} data-aos={"fade-up"}>
                        ...
                        <div className={"lecture-offer"} data-aos={"fade-up"}>
                        ...
                        <div className={"hosting-offer"} data-aos={"fade-up"}>
                        ...
                        <div className={"training-offer"} data-aos={"fade-up"}>
