...
import { Navbar, Product, PayPalCheckoutButton, Popup } from '../../../../components';
        ...
        return(
            <div className={styles.checkout}>
                <Head>
                    ...
                    <meta property="og:url" content="https://cyriljuniordim.com/bookings/coaching/checkout"/>
                ...
                <div className={styles.checkoutDetailsContainer}>
                    ...
                    <div className={`${styles.checkoutDetails} section__padding`}>
                        <div className={styles.checkoutHelp}>
                            <RiQuestionLine color="#000000" size={32} onClick={() => setButtonPopup(true)}/>
                        </div>
                        <Product
                            title={product.title}
